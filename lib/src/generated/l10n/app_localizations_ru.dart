...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get argumentsHint => 'напр. config.toml';
  ...
  String get localModeHint =>
      '1. Перейдите в Настройку службы\n2. Включите Общий режим\n3. Перезапустите службу\n4. Отсканируйте QR-код для доступа к ZeroClaw';

  @override
  String get publicModeHint =>
      '1. Запустите службу\n2. Отсканируйте QR-код для доступа к ZeroClaw';
  ...
  @override
  String get shareLogsText => 'Журналы ZeroClaw';
  ...
  String get aboutDescription =>
      'ZeroClaw — это кроссплатформенное Flutter-приложение для управления сервисом ZeroClaw.';

  @override
  String get aboutAppVersionLabel => 'Версия ZeroClaw';

  @override
  String get aboutCoreVersionLabel => 'Версия ZeroClaw Core';

  @override
  String get aboutVersionUnavailable => 'Недоступно';

  @override
  String get zeroclawOfficial => 'Официальный сайт ZeroClaw';
